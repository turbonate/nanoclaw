...
This workflow adds Slack support to NanoClaw, then walks through interactive setup.
...
If the user doesn't have a Slack app, share step-by-step instructions:
...
- **Workspace admin policies not detected** — If the Slack workspace restricts bot app installation, the setup will fail at the "Install to Workspace" step with no programmatic detection or guidance.
